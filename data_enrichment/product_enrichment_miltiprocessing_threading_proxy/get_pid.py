from product_enrichment_multiprocessing.save_files import save_pid_url_by_collection
...
def get_product_id():
    os.environ["GOOGLE_APPLICATION_CREDENTIALS"] = "glamira-project-464503-a80775406a71.json"
    url = "mongodb://34.143.242.195:27017/"
